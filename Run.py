...
if __name__ == "__main__":
    ...
    parser.add_argument("-result_path", default = './result_author/')
    ...
    for num,seq in enumerate(seq_list):
        ...
        save_path = opts['result_path'] + seq + '.mat'
